...
public class checkuser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Usuario Ingresado: " + request.getParameter("inputEmail") + "</h1>");
            
            while(rs.next()){
                    out.println("<h3>Bienvenido al sitio...."+"<BR>");
                    out.println(rs.getString("nombreyapellido"));
            }
            
            if(rs.first() == false){
              out.println("Usuario/Clave Incorrecta");
            }
